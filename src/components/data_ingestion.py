...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df =pd.read_csv("/home/eru/Ml-project/project-1/notebook/data/StudentsPerformance.csv")
            ...
            logging.info("Error in data ingestion file")
...
if __name__=="__main__":
    ...
    train_data_arr,test_data_arr,obj = data_transformation.initiate_data_transformation(train_data,test_data)
